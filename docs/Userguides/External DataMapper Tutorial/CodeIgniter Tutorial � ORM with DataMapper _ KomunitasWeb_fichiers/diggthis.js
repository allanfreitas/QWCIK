...
}else{K=window.onload;window.onload=K?function(){K();J()}:J}}return{writeLink:A,addButtons:C,collectDiggs:function(k){var h=b[escape(k.url).replace("+","%2b","g")],g=h.length,j=0;
